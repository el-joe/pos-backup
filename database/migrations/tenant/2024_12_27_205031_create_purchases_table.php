...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // - purchase_variables : purchase_id , product_variable_id , unit_id ,qty , purchase_price , discount_percentage , price(after discount) , total , x_margin_percentage , sale_price
