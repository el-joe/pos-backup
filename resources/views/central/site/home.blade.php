		...
		<div id="home" class="py-5 position-relative bg-body bg-opacity-50" data-bs-theme="dark">
			...
			<div class="container-xxl p-3 p-lg-5 mb-0">
					...
					<div class="row">
						...
						<div class="col-lg-6">
							...
							<div class="fs-18px text-body text-opacity-75 mb-4">
								Manage your entire business from one intelligent dashboard. <span class="d-xl-inline d-none"><br></span>
								Streamline sales, inventory, accounting, HR, and operations using a modern ERP <span class="d-xl-inline d-none"><br></span>
							...
							<div class="mb-2">
								<a href="index.html" class="btn btn-lg btn-outline-white px-3">Explore ERP Features <i class="fa fa-arrow-right ms-2 opacity-5"></i></a>
							</div>
				...
				<div class="position-absolute top-0 bottom-0 end-0 w-50 p-5 z-2 overflow-hidden d-lg-flex align-items-center d-none">
					<img class="w-100 d-block shadow-lg" alt="HUD" src="{{ asset('hud/assets/img/landing/mockup-1.jpg') }}">
				</div>
			</div>
			<!-- END container -->
			<div class="position-absolute bg-size-cover bg-position-center d-none2 bg-no-repeat top-0 start-0 w-100 h-100" style="background-image: url(assets/img/landing/cover.jpg);"></div>
			<div class="position-absolute top-0 start-0 d-none2 w-100 h-100 opacity-95" style="background: var(--bs-body-bg-gradient);"></div>
			<div class="position-absolute top-0 start-0 d-none2 w-100 h-100 opacity-95" style="background-image: url(assets/css/images/pattern-dark.png); background-size: var(--bs-body-bg-image-size);"></div>
		</div>
		<!-- END #home -->
    ...
    <div class="container-xxl p-3 p-lg-5 text-center">
        ...
        <div class="row text-start g-3 gx-lg-5 gy-lg-4">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
                <div class="w-50px h-50px bg-theme bg-opacity-15 text-theme fs-32px d-flex align-items-center justify-content-center">
                    <iconify-icon icon="solar:monitor-smartphone-line-duotone"></iconify-icon>
                </div>
                <div class="flex-1 ps-3">
                    <h4>Complete Business Control</h4>
                    <p class="mb-0">Manage sales, purchases, accounting, inventory, HR, and more—all from a unified dashboard.</p>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
                ...
                <div class="flex-1 ps-3">
                    ...
                    <p class="mb-0">Tailor features, workflows, permissions, and reports to suit your exact business operations.</p>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
                ...
                <div class="flex-1 ps-3">
                    ...
                    <p class="mb-0">Monitor sales, stock, profits, and financial reports instantly with real-time analytics.</p>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
                ...
                <div class="flex-1 ps-3">
                    ...
                    <p class="mb-0">Role-based permissions, encrypted data, and secure cloud infrastructure protect your business 24/7.</p>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
                ...
                <div class="flex-1 ps-3">
                    ...
                    <p class="mb-0">Manage multiple branches, warehouses, users, and departments with centralized control.</p>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
                ...
                <div class="flex-1 ps-3">
                    ...
                    <p class="mb-0">Grow your business with a flexible system that scales smoothly as your needs expand.</p>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
                ...
                <div class="flex-1 ps-3">
                    ...
                    <p class="mb-0">Designed for simplicity, speed, and productivity—no technical experience required.</p>
                </div>
            </div>
			...
			<div class="container-xxl p-3 p-lg-5 z-2 position-relative">
				...
				<div class="row g-3 g-lg-5">
					<div class="col-xl-3 col-lg-4 col-sm-6">
						<a href="{{ asset('hud/assets/') }}/img/landing/mockup-1.jpg" data-lity class="shadow d-block"><img src="{{ asset('hud/assets/') }}/img/landing/mockup-1-thumb.jpg" alt="" class="mw-100"></a>
						<div class="text-center my-3 text-body fw-bold">Theme Dashboard</div>
					</div>
					<div class="col-xl-3 col-lg-4 col-sm-6">
						<a href="{{ asset('hud/assets/') }}/img/landing/mockup-2.jpg" data-lity class="shadow d-block"><img src="{{ asset('hud/assets/') }}/img/landing/mockup-2-thumb.jpg" alt="" class="mw-100"></a>
						<div class="text-center my-3 text-body fw-bold">POS System UI</div>
					</div>
					<div class="col-xl-3 col-lg-4 col-sm-6">
						<a href="{{ asset('hud/assets/') }}/img/landing/mockup-3.jpg" data-lity class="shadow d-block"><img src="{{ asset('hud/assets/') }}/img/landing/mockup-3-thumb.jpg" alt="" class="mw-100"></a>
						<div class="text-center my-3 text-body fw-bold">Email Inbox</div>
					</div>
					<div class="col-xl-3 col-lg-4 col-sm-6">
						<a href="{{ asset('hud/assets/') }}/img/landing/mockup-4.jpg" data-lity class="shadow d-block"><img src="{{ asset('hud/assets/') }}/img/landing/mockup-4-thumb.jpg" alt="" class="mw-100"></a>
						<div class="text-center my-3 text-body fw-bold">Pricing Page</div>
					</div>
					<div class="col-xl-3 col-lg-4 col-sm-6">
						<a href="{{ asset('hud/assets/') }}/img/landing/mockup-5.jpg" data-lity class="shadow d-block"><img src="{{ asset('hud/assets/') }}/img/landing/mockup-5-thumb.jpg" alt="" class="mw-100"></a>
						<div class="text-center my-3 text-body fw-bold">User Profile</div>
					</div>
					<div class="col-xl-3 col-lg-4 col-sm-6">
						<a href="{{ asset('hud/assets/') }}/img/landing/mockup-6.jpg" data-lity class="shadow d-block"><img src="{{ asset('hud/assets/') }}/img/landing/mockup-6-thumb.jpg" alt="" class="mw-100"></a>
						<div class="text-center my-3 text-body fw-bold">Analytics Page</div>
					</div>
					<div class="col-xl-3 col-lg-4 col-sm-6">
						<a href="{{ asset('hud/assets/') }}/img/landing/mockup-7.jpg" data-lity class="shadow d-block"><img src="{{ asset('hud/assets/') }}/img/landing/mockup-7-thumb.jpg" alt="" class="mw-100"></a>
						<div class="text-center my-3 text-body fw-bold">HUD Widgets</div>
					</div>
					<div class="col-xl-3 col-lg-4 col-sm-6">
						<a href="{{ asset('hud/assets/') }}/img/landing/mockup-8.jpg" data-lity class="shadow d-block"><img src="{{ asset('hud/assets/') }}/img/landing/mockup-8-thumb.jpg" alt="" class="mw-100"></a>
						<div class="text-center my-3 text-body fw-bold">Kitchen Order Page</div>
					</div>
					<div class="col-xl-3 col-lg-4 col-sm-6">
						<a href="{{ asset('hud/assets/') }}/img/landing/mockup-9.jpg" data-lity class="shadow d-block"><img src="{{ asset('hud/assets/') }}/img/landing/mockup-9-thumb.jpg" alt="" class="mw-100"></a>
						<div class="text-center my-3 text-body fw-bold">Order Details Page</div>
					</div>
					<div class="col-xl-3 col-lg-4 col-sm-6">
						<a href="{{ asset('hud/assets/') }}/img/landing/mockup-10.jpg" data-lity class="shadow d-block"><img src="{{ asset('hud/assets/') }}/img/landing/mockup-10-thumb.jpg" alt="" class="mw-100"></a>
						<div class="text-center my-3 text-body fw-bold">Messenger</div>
					</div>
					<div class="col-xl-3 col-lg-4 col-sm-6">
						<a href="{{ asset('hud/assets/') }}/img/landing/mockup-11.jpg" data-lity class="shadow d-block"><img src="{{ asset('hud/assets/') }}/img/landing/mockup-11-thumb.jpg" alt="" class="mw-100"></a>
						<div class="text-center my-3 text-body fw-bold">Table Control Page</div>
					</div>
					<div class="col-xl-3 col-lg-4 col-sm-6">
						<a href="{{ asset('hud/assets/') }}/img/landing/mockup-12.jpg" data-lity class="shadow d-block"><img src="{{ asset('hud/assets/') }}/img/landing/mockup-12-thumb.jpg" alt="" class="mw-100"></a>
						...
						<form action="{{ route('contact-us') }}" method="POST">
							...
							<div class="row gy-3 mb-3">
								<div class="col-6">
									...
									<input type="text" class="form-control form-control-lg fs-15px" name="fname" required>
                                    @if ($errors->has('fname'))
								...
								<div class="col-6">
									...
									<input type="text" class="form-control form-control-lg fs-15px" name="lname" required>
                                    @if ($errors->has('lname'))
								...
								<div class="col-6">
									...
									<input type="text" class="form-control form-control-lg fs-15px" name="email" required>
                                    @if ($errors->has('email'))
								...
								<div class="col-12">
									<button type="submit" class="btn btn-outline-theme btn-lg btn-block px-4 fs-15px">Send Message</button>
								</div>
							</div>
						</form>
					</div>
