...
<head>
    ...
    @include('layouts.cpanel.partials.styles')
    @stack('styles')
    @livewireStyles
</head>
<body>
	...
	<div id="app" class="app {{ isset($withoutSidebar) ? 'app-content-full-height app-without-sidebar app-without-header' : ''  }}">
        ...
        @include('layouts.cpanel.partials.header')
        @include('layouts.cpanel.partials.sidebar')
        @endif
		<!-- BEGIN #content -->
	...
	<!-- END #app -->
    @include('layouts.cpanel.partials.scripts')
    @livewireScripts
    @stack('scripts')
    @livewire('operations')
