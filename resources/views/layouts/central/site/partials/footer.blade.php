        ...
        <div class="row gx-lg-5 gx-3 gy-lg-4 gy-3">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled">
                    <li class="mb-3px"><a href="{{ route('lang.static-page.localized', ['lang' => $__currentLang, 'slug' => 'about-us']) }}" class="text-decoration-none text-body text-opacity-75">{{ __('website.footer.legal_links.about_us') }}</a></li>
                    <li class="mb-3px"><a href="{{ route('lang.static-page.localized', ['lang' => $__currentLang, 'slug' => 'privacy-policy']) }}" class="text-decoration-none text-body text-opacity-75">{{ __('website.footer.legal_links.privacy_policy') }}</a></li>
                    <li class="mb-3px"><a href="{{ route('lang.static-page.localized', ['lang' => $__currentLang, 'slug' => 'terms-conditions']) }}" class="text-decoration-none text-body text-opacity-75">{{ __('website.footer.legal_links.terms_of_service') }}</a></li>
                    <li class="mb-3px"><a href="{{ route('lang.static-page.localized', ['lang' => $__currentLang, 'slug' => 'refund-cancellation-policy']) }}" class="text-decoration-none text-body text-opacity-75">{{ __('website.footer.legal_links.refund_cancellation_policy') }}</a></li>
                    <li class="mb-3px"><a href="{{ route('lang.static-page.localized', ['lang' => $__currentLang, 'slug' => 'fair-usage-policy']) }}" class="text-decoration-none text-body text-opacity-75">{{ __('website.footer.legal_links.fair_usage_policy') }}</a></li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-3px"><a href="{{ route('lang.faqs.index', ['lang' => $__currentLang]) }}" class="text-decoration-none text-body text-opacity-75">{{ __('website.footer.resources_links.faqs') }}</a></li>
