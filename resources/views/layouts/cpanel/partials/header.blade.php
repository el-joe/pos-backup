...
<div id="header" class="app-header">
    ...
    <!-- BEGIN brand -->
    <div class="brand">
        <a href="{{ route('cpanel.dashboard') }}" class="brand-logo">
            ...
            <span class="brand-text">{{ cpanelAdmin()->name }}</span>
        </a>
    </div>
    <!-- END brand -->
        ...
        <div class="menu-item dropdown dropdown-mobile-full">
            ...
            <div class="dropdown-menu dropdown-menu-{{ $__locale == 'en' ? 'end' : 'start' }} mt-1 w-300px fs-11px pt-1">
                ...
                <div class="py-10px mb-n2 text-center">
                    <a href="#" class="text-decoration-none fw-bold">{{ __('general.layout.see_all') }}</a>
                </div>
            </div>
        </div>
        <div class="menu-item dropdown dropdown-mobile-full">
                ...
                <div class="dropdown-menu  me-lg-3 fs-11px mt-1 dropdown-menu-end dropdown-menu-lg-{{ $__locale == 'en' ? 'end' : 'start' }}">
                    <h6 class="dropdown-header"> {{ __('general.pages.admins.name') }} : {{ cpanelAdmin()->name }}</h6>
                    ...
                    <div class="dropdown-divider"></div> --}}
                    <a class="dropdown-item d-flex align-items-center" href="{{ route('cpanel.logout') }}">{{ __('general.layout.logout') }} <i class="bi bi-toggle-off ms-auto text-theme fs-16px my-n1"></i></a>
                </div>
        </div>
