                            ...
                            <div class="card-body h-100 p-1">
                                <a href="javascript:" class="pos-product" @if($product->unit->children->count() > 0) data-bs-toggle="modal" data-bs-target="#modalPosItem" wire:click="setCurrentProduct({{ $product->id }})" @else  wire:click="addToCart({{ $product->id }})"  @endif>
                                    ...
                                    <div class="info">
                                        ...
                                        <div class="price">{{ currency()->symbol }}{{ $product->stockSellPrice($this->data['branch_id'] ?? null) }}</div>
                                    </div>
                                </a>
                            </div>
                            <div class="card-arrow">
        ...
        <div class="d-flex flex-column p-0">
                        ...
                        <div class="pos-order">
                            <div class="pos-order-product">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="small">{{ currency()->symbol }}{{ $dataProduct['sell_price'] }}</div>
                            ...
                            <div class="pos-order-price">
                                {{ currency()->symbol }}{{ $dataProduct['subtotal'] }}
                            </div>
                        </div>
                    @empty
            ...
            <div class="pos-sidebar-footer">
                <div class="d-flex align-items-center mb-2">
                    ...
                    <div class="flex-1 text-end h6 mb-0">{{ currency()->symbol }}{{ $subTotal }}</div>
                </div>
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">
                                        ...
                                        @if($data['discount']['max_discount_amount'] ?? 0)
                                            <span class="text-muted">({{ __('general.pages.pos-page.max') }}: {{ currency()->symbol }}{{ $data['discount']['max_discount_amount'] ?? 0 }})</span>
                                        @endif
                                    </small>
                                </div>
                                <div class="text-end">
                                    <div class="fw-bold h6 mb-0 text-success">{{ currency()->symbol }}{{ $discount }}</div>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-1 text-end h6 mb-0">{{ currency()->symbol }}{{ $tax }}</div>
                </div>
                <hr>
                <div class="d-flex align-items-center mb-2">
                    <div>{{ __('general.pages.pos-page.total') }}</div>
                    <div class="flex-1 text-end h4 mb-0">{{ currency()->symbol }}{{ $total }}</div>
                </div>
                <div class="mt-3">
