...
<script src="{{ asset('adminBoard') }}/plugins/components/sparkline/jquery.sparkline.min.js"></script>
<script src="{{ asset('adminBoard') }}/plugins/components/sparkline/jquery.charts-sparkline.js"></script>
<script src="{{ asset('adminBoard') }}/plugins/components/knob/jquery.knob.js"></script>
<script src="{{ asset('adminBoard') }}/plugins/components/easypiechart/dist/jquery.easypiechart.min.js"></script>
<script src="{{ asset('adminBoard/cubic-html') }}/js/db1.js"></script>
<!-- ===== Style Switcher JS ===== -->
