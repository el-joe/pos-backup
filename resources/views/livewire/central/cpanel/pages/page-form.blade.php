        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" wire:model.defer="data.slug" placeholder="about-us">
                ...
                <div class="col-md-6">
                    ...
                    <textarea class="form-control" rows="3" wire:model.defer="data.short_description_en"></textarea>
                </div>

                <div class="col-md-6">
                    <label class="form-label">Short Description (AR)</label>
                    <textarea class="form-control" rows="3" wire:model.defer="data.short_description_ar"></textarea>
                </div>
