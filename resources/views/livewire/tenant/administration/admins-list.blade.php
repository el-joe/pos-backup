<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="mb-5 h4 col-sm-6">Admins List <code>({{ $admins->total() }})</code></div>
                <div class="col-sm-6">
                ...
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">{{ isset($current) ? 'Edit' : 'Add New' }} Admin</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="email" wire:model="data.email" id="email" class="form-control">
                            </div>
                            <div class="form-group col-sm-6">
                                <label for="password">Password</label>
                                <input type="password" wire:model="data.password" id="password" class="form-control">
                            </div>
                            {{-- <div class="form-group col-sm-6">
                                <label for="password_confirmation">Password Confirmation</label>
                                <input type="text" wire:model="data.password_confirmation" id="password_confirmation" class="form-control">
                            </div> --}}
                            <div class="form-group col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <label class="toggle-switch toggle-switch-info">
                                    <input type="checkbox" wire:model="data.active" {{($data['active']??0) == 1 ? 'checked' : ''}} {{tenant()->email == ($current?->email ?? "") ? 'disabled' : ''}}>
