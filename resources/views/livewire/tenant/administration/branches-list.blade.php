<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="mb-5 h4 col-sm-6">Branches List <code>({{ $branches->total() }})</code></div>
                <div class="col-sm-6">
                ...
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">{{ isset($current) ? 'Edit' : 'Add New' }} Branch</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" wire:model="data.website" id="website" class="form-control">
                            </div>
