<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="mb-5 h4 col-sm-6">{{ $id == 'customer' ? 'Customers' : 'Suppliers' }} List <code>({{ $contacts->total() }})</code></div>
                <div class="col-sm-6">
                    ...
                    <tbody>
                        @foreach ($contacts as $contact)
                            <tr>
                                ...
                                <td>
                                    <span class="badge badge-{{$contact->active == 0 ? 'danger' : 'info'}}">
                                        {{$contact->active ? 'YES' : 'NO'}}
                                    </span>
                                </td>
                                <td>
                                    <button type="button" class="btn btn-dark btn-xs" data-toggle="modal" data-target=".add-edit-modal" wire:click="setCurrent({{$contact->id}})">
                                        <i class="icon-eye"></i>
                                    </button>
                                    <button class="btn btn-danger btn-xs" wire:click="setCurrent({{$contact->id}})" data-toggle="modal" data-target=".delete-modal">
                ...
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">{{ isset($current) ? 'Edit' : 'Add New' }} Contact</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                ...
                                <input type="text" wire:model="data.address" id="address" class="form-control">
                            </div>
                            <div class="col">
