<div class="col-12">
    <x-tenant-tailwind-gemini.filter-card :title="__('general.pages.purchases.filters')" icon="fa-filter" collapse-id="branchFilterCollapse" :collapsed="$collapseFilters">
        <x-slot:actions>
