<div class="col-12">
    <x-tenant-tailwind-gemini.filter-card :title="__('general.pages.transactions.filters')" icon="fa-filter" collapse-id="hudTransactionsFilterCollapse" :collapsed="$collapseFilters">
        <x-slot:actions>
    ...
    <x-tenant-tailwind-gemini.table-card :title="__('general.pages.transactions.transactions_list')" icon="fa-exchange" :render-table="false">
        <x-slot:actions>
