<div class="col-12">
    <x-tenant-tailwind-gemini.filter-card :title="__('general.pages.stock-taking.filters')" icon="fa-filter" collapse-id="hudStockTakingFilterCollapse" :collapsed="$collapseFilters">
        <x-slot:actions>
    ...
    <x-tenant-tailwind-gemini.table-card :title="__('general.titles.stock-adjustments')" icon="fa-balance-scale" :render-table="false">
        <x-slot:actions>
