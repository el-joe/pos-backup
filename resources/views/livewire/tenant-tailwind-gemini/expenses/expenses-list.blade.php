<div class="col-12">
    <x-tenant-tailwind-gemini.filter-card :title="__('general.pages.expenses.filters')" icon="fa-filter" collapse-id="hudExpenseFilterCollapse" :collapsed="$collapseFilters">
        <x-slot:actions>
