<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-12">
            <x-tenant-tailwind-gemini.table-card :title="__('general.pages.reports.sales.return.title')" icon="fa-undo" :render-table="false">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover mb-0 align-middle">
                            ...
                            <tbody>
                                ...
                                @endforelse
                                @if(count($report))
                                    <tr class="bg-emerald-50 font-bold text-slate-900 dark:bg-emerald-900/30 dark:text-white">
