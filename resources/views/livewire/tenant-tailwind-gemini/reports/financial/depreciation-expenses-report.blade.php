    ...
    <div class="row g-3 mb-4">
        <div class="col-md-4">
            <div class="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm dark:bg-slate-900 dark:border-slate-700">
                <div class="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400">{{ __('general.pages.reports.financial.depreciation_expenses_report.expenses_count') }}</div>
                <div class="mt-3 text-3xl font-semibold text-slate-900 dark:text-white">{{ $count }}</div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm dark:bg-slate-900 dark:border-slate-700">
                <div class="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400">{{ __('general.pages.reports.financial.depreciation_expenses_report.total_amount') }}</div>
                <div class="mt-3 text-3xl font-semibold text-slate-900 dark:text-white">{{ currencyFormat($totalAmount, true) }}</div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm dark:bg-slate-900 dark:border-slate-700">
                <div class="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400">{{ __('general.pages.reports.financial.depreciation_expenses_report.avg_amount') }}</div>
                <div class="mt-3 text-3xl font-semibold text-slate-900 dark:text-white">{{ currencyFormat($avg, true) }}</div>
            </div>
        </div>
    </div>
