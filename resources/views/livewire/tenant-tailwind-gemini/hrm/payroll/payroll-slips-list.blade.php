<div class="col-12">
    <x-tenant-tailwind-gemini.filter-card :title="__('general.titles.hrm_payslips')" icon="fa-filter" collapse-id="hrmPayslipsFilterCollapse" :collapsed="$collapseFilters">
        <x-slot:actions>
    ...
    <x-tenant-tailwind-gemini.table-card :title="__('general.titles.hrm_payslips')" icon="fa-file-text-o">
        <x-slot:head>
            <tr>
