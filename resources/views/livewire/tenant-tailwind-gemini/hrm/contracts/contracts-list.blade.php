<div class="col-12">
    <x-tenant-tailwind-gemini.filter-card :title="__('general.titles.hrm_contracts')" icon="fa-filter" collapse-id="hrmContractsFilterCollapse" :collapsed="$collapseFilters">
        <x-slot:actions>
    ...
    <x-tenant-tailwind-gemini.table-card :title="__('general.titles.hrm_contracts')" icon="fa-file-contract">
        <x-slot:actions>
