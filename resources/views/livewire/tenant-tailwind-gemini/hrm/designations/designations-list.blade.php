<div class="col-12">
    <x-tenant-tailwind-gemini.filter-card :title="__('general.titles.hrm_designations')" icon="fa-filter" collapse-id="hrmDesignationsFilterCollapse" :collapsed="$collapseFilters">
        <x-slot:actions>
    ...
    <x-tenant-tailwind-gemini.table-card :title="__('general.titles.hrm_designations')" icon="fa-id-badge">
        <x-slot:actions>
