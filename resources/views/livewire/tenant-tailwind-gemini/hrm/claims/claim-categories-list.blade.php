            ...
            <tbody class="divide-y divide-slate-100 border-t border-slate-100 dark:divide-slate-800 dark:border-slate-800">
                @forelse($categories as $c)
                    <tr class="transition-colors hover:bg-slate-50 dark:hover:bg-slate-800/50">
                        ...
                        <td class="px-5 py-4 font-medium text-slate-900 dark:text-white">{{ $c->name }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="3" class="px-5 py-8 text-center text-sm text-slate-500 dark:text-slate-400">
                            {{ __('general.pages.hrm.no_data_found') ?? 'No claim categories found.' }}
                        </td>
                    </tr>
                @endforelse
            </tbody>
