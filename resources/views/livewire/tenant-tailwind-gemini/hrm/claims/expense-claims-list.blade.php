<div class="col-12">
    <x-tenant-tailwind-gemini.filter-card :title="__('general.titles.hrm_expense_claims')" icon="fa-filter" collapse-id="hrmExpenseClaimsFilterCollapse" :collapsed="$collapseFilters">
        <x-slot:actions>
    ...
    <x-tenant-tailwind-gemini.table-card :title="__('general.titles.hrm_expense_claims')" icon="fa-receipt">
        <x-slot:head>
            <tr>
