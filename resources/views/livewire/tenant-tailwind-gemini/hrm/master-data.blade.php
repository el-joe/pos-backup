            ...
            <div class="p-5">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover align-middle">
                        ...
                        <tbody>@foreach($designations as $d)<tr>
                                <td>{{ $d->id }}</td>
                                <td>{{ $d->title }}</td>
        ...
        <div class="p-5">
            <div class="table-responsive">
                <table class="table table-bordered table-hover align-middle">
                    ...
                    <tbody>@foreach($employees as $e)<tr>
                            <td>{{ $e->id }}</td>
        ...
        <div class="p-5">
            <div class="table-responsive">
                <table class="table table-bordered table-hover align-middle">
                    ...
                    <tbody>@foreach($contracts as $c)<tr>
                            <td>{{ $c->id }}</td>
                            ...
                            <td><span class="inline-flex rounded-full px-3 py-1 text-xs font-semibold {{ $c->is_active ? 'bg-emerald-50 text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-300' : 'bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300' }}">{{ $c->is_active ? __('general.pages.hrm.yes') : __('general.pages.hrm.no') }}</span></td>
                        </tr>@endforeach</tbody>
                </table>
            </div>
        </div>
