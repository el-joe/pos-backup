<div class="col-12">
    <x-tenant-tailwind-gemini.filter-card :title="__('general.titles.hrm_employees')" icon="fa-filter" collapse-id="hrmEmployeesFilterCollapse" :collapsed="$collapseFilters">
        <x-slot:actions>
    ...
    <x-tenant-tailwind-gemini.table-card :title="__('general.titles.hrm_employees')" icon="fa-users">
        <x-slot:actions>
