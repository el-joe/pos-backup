<div class="col-12">
    <x-tenant-tailwind-gemini.filter-card :title="__('general.titles.hrm_departments')" icon="fa-filter" collapse-id="hrmDepartmentsFilterCollapse" :collapsed="$collapseFilters">
        <x-slot:actions>
    ...
    <x-tenant-tailwind-gemini.table-card :title="__('general.titles.hrm_departments')" icon="fa-building">
        <x-slot:actions>
