<div class="col-12">
    <x-tenant-tailwind-gemini.filter-card :title="__('general.pages.hrm.filters')" icon="fa-filter" collapse-id="hrmAttendanceFilterCollapse" :collapsed="$collapseFilters">
        <x-slot:actions>
    ...
    <x-tenant-tailwind-gemini.table-card :title="__('general.titles.hrm_attendance_sheets')" icon="fa-calendar-check-o">
        <x-slot:actions>
