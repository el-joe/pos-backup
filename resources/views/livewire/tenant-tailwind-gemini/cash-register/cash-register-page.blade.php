            ...
            <div class="grid gap-6 xl:grid-cols-[1.45fr_minmax(340px,0.9fr)]">
                ...
                <x-tenant-tailwind-gemini.table-card :title="__('general.pages.cash_register.open_close_register')">
                    <div class="space-y-5 p-5">
                        @if($currentRegister)
                            <div wire:key="register-open-view" class="space-y-5">
                        ...
                        @else
                            <div wire:key="register-closed-view" class="space-y-5">
                                ...
                                <div class="space-y-5">
                                    ...
                                    @if(admin()->branch_id === null)
                                        <div wire:ignore>
                                            ...
                                            <select class="select2 block w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-900 shadow-sm transition-all focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 dark:border-slate-700 dark:bg-slate-900 dark:text-white dark:focus:border-emerald-500" name="branchId">
