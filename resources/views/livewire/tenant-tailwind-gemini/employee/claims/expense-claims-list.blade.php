<div class="col-12">
    <x-tenant-tailwind-gemini.filter-card title="New Expense Claim" icon="fa-plus-square">
        <div class="row g-3">
            <div class="col-md-4">
    ...
    <x-tenant-tailwind-gemini.table-card title="My Expense Claims" icon="fa-receipt">
        <x-slot:head>
            <tr>
                <th>ID</th>
                <th>Date</th>
