<div class="col-12">
    <x-tenant-tailwind-gemini.table-card :title="$product->name" icon="fa-cube" :render-table="false" class="mb-3">
        <x-slot:actions>
        ...
        <div class="px-5 pt-2 text-sm text-slate-500 dark:text-slate-400">
