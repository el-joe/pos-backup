<div class="col-12">
    <x-tenant-tailwind-gemini.filter-card :title="__('general.pages.admins.filters')" icon="fa-filter" collapse-id="branchFilterCollapse" :collapsed="$collapseFilters">
        <x-slot:actions>
    ...
    <x-tenant-tailwind-gemini.table-card :title="__('general.pages.admins.admins')" icon="fa-user-secret">
        <x-slot:actions>
