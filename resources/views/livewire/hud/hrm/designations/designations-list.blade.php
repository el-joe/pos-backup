<div class="col-12">
    <div class="card shadow-sm mb-3">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">{{ __('general.titles.hrm_designations') }}</h5>
            ...
            <div class="d-flex gap-2">
                <button class="btn btn-sm btn-outline-primary"
                        ...
                        data-bs-target="#hrmDesignationsFilterCollapse">
        ...
        <div class="collapse {{ $collapseFilters ? 'show' : '' }}" id="hrmDesignationsFilterCollapse">
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-4">
                        <label class="form-label">{{ __('general.pages.hrm.search') }}</label>
                        <input type="text" class="form-control" placeholder="Designation title..." wire:model.blur="filters.search">
                    </div>
