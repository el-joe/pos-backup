<div class="col-12">
    <x-hud.filter-card :title="__('general.titles.hrm_leave_types')" icon="fa-filter" collapse-id="hrmLeaveTypesFilterCollapse" :collapsed="$collapseFilters">
        <x-slot:actions>
    ...
    <x-hud.table-card :title="__('general.titles.hrm_leave_types')" icon="fa-calendar">
        <x-slot:actions>
