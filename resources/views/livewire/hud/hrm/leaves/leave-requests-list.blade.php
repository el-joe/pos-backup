<div class="col-12">
    <x-hud.filter-card :title="__('general.titles.hrm_leave_requests')" icon="fa-filter" collapse-id="hrmLeaveRequestsFilterCollapse" :collapsed="$collapseFilters">
        <x-slot:actions>
    ...
    <x-hud.table-card :title="__('general.titles.hrm_leave_requests')" icon="fa-calendar-minus-o">
        <x-slot:head>
            <tr>
