<div class="col-12">
    <x-hud.filter-card :title="__('general.titles.hrm_claim_categories')" icon="fa-filter" collapse-id="hrmClaimCategoriesFilterCollapse" :collapsed="$collapseFilters">
        <x-slot:actions>
    ...
    <x-hud.table-card :title="__('general.titles.hrm_claim_categories')" icon="fa-tags">
        <x-slot:actions>
