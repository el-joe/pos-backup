<div class="col-12">
    <x-hud.filter-card :title="__('general.pages.sale_requests.filters')" icon="fa-filter" collapse-id="saleRequestFilterCollapse" :collapsed="$collapseFilters">
        <x-slot:actions>
    ...
    <x-hud.table-card :title="__('general.pages.sale_requests.sale_requests')" icon="fa-file-text">
        <x-slot:actions>
