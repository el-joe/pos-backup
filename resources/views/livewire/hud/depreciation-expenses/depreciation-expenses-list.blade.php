<div class="col-12">
    <x-hud.filter-card :title="__('general.pages.depreciation_expenses.filters')" icon="fa-filter" collapse-id="depreciationFilterCollapse" :collapsed="$collapseFilters">
        <x-slot:actions>
    ...
    <x-hud.table-card :title="__('general.pages.depreciation_expenses.depreciation_expenses')" icon="fa-line-chart">
        <x-slot:actions>
