<div class="col-12">
    <x-hud.filter-card :title="__('general.titles.stocks')" icon="fa-filter" collapse-id="stocksFilterCollapse" :collapsed="$collapseFilters">
        <x-slot:actions>
    ...
    <x-hud.table-card :title="__('general.pages.stocks.stocks_list')" icon="fa-warehouse">
        <x-slot:actions>
