<div class="container-fluid">
    ...
    <div class="col-12">
        <x-hud.table-card :title="__('general.pages.reports.purchases.discount.title')" icon="fa-tag" :render-table="false">
            <div class="table-responsive">
                <table class="table table-dark table-hover table-striped align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="2" class="text-center text-muted">{{ __('general.pages.reports.purchases.discount.no_data') }}</td>
                                </tr>
                            @endforelse
