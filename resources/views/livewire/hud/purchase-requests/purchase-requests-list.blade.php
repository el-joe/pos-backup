<div class="col-12">
    <x-hud.filter-card :title="__('general.pages.purchase_requests.filters')" icon="fa-filter" collapse-id="purchaseRequestFilterCollapse" :collapsed="$collapseFilters">
        <x-slot:actions>
    ...
    <x-hud.table-card :title="__('general.pages.purchase_requests.purchase_requests')" icon="fa-file-text-o">
        <x-slot:actions>
