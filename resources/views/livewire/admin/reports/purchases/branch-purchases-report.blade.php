...
<div class="white-box">
    <h3 class="box-title">Branch Purchases Report</h3>
    ...
    <div class="card section-card">
        <div class="card-body">
            <h4 class="section-title"><i class="fa fa-building"></i> Branch Purchases</h4>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="3" class="text-center">No branch purchases found for selected period.</td>
                    </tr>
                    @endforelse
                    @if(count($report))
